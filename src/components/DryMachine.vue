<template>
  <body class="body">
   <div class="head">
    ...
    <router-link to="/Washing" class="WashingButton">
        <button type="Washingbtm" class="WashingBtm">เครื่องซักผ้า
        <svg
                width="16"
                height="19"
                viewBox="0 0 16 19"
      ...
      <div class="machine-list">
        ...
        >
          ...
          <router-link
            ...
            :to="{ name: 'PaymentDry', query: { id: machine.id } }"
...
export default {
  ...
  data() {
    return {
      washingMachines: [
        { id: 1, status: "Available", remainingTime: null, image: require("@/assets/image/Dry.avif") },
        { id: 2, status: "In Use", remainingTime: 600, image: require("@/assets/image/Dry.avif") },
        { id: 3, status: "In Use", remainingTime: 1200, image: require("@/assets/image/Dry.avif") },
        { id: 4, status: "Available", remainingTime: null, image: require("@/assets/image/Dry.avif") },
        { id: 5, status: "Available", remainingTime: null, image: require("@/assets/image/Dry.avif") },
        { id: 6, status: "In Use", remainingTime: 900, image: require("@/assets/image/Dry.avif") },
      ],
    };
  },
  methods: {
